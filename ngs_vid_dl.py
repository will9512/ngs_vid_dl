...
def parse_arguments():
    ...
    parser.add_argument('--page-url', help='URL of the page to navigate to (default: videos). Can be "watch", "exclusive", or any valid URL.', default='https://play.nugs.net/watch/videos/recent')
